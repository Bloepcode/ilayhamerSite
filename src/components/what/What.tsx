...
function What(props: WhatProps) {
  ...
  console.log(values);
  return (
    <div className="w-4/5 h-fit bg-neutral-100 bg-opacity-40 rounded-3xl border-4 border-neutral-100 border-opacity-30 p-12 m-6">
      ...
      <div className="flex flex-row justify-between items-center">
        {props.children}
        <div className="m-16">{props.logo}</div>
      </div>
    </div>
  );
}
